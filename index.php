    ...
    <div class="container">
        ...
        <div class="col-md-6">
          <div class="panel panel-default">
            <div class="panel-heading colorHeading">
              <h3 class="panel-title"><i class="fa fa-clock-o"></i>&nbsp;Hours</h3>
            </div>
            ...
            <div class="panel-body text-center">
              <div class="row">
                <a href="images/burger.jpg" class="swipebox" title="Green Chili Burger">
                  <img src="images/thumbnails/burger.jpg" alt="image" class="swipeboxImage">
                </a>
                <a href="images/chicken.jpg" class="swipebox" title="Chicken Skewer">
                  <img src="images/thumbnails/chicken.jpg" alt="image" class="swipeboxImage">
                </a>
                <a href="images/greek-salad.jpg" class="swipebox" title="Greek Salad">
                  <img src="images/thumbnails/greek-salad.jpg" alt="image" class="swipeboxImage">
                </a>
              </div>

              <div class="row">
                <a href="images/gyros.jpg" class="swipebox" title="Gyros">
                  <img src="images/thumbnails/gyros.jpg" alt="image" class="swipeboxImage">
                </a>
                <a href="images/lamb.jpg" class="swipebox" title="Lamb">
                  <img src="images/thumbnails/lamb.jpg" alt="image" class="swipeboxImage">
                </a>
                <a href="images/shrimp.jpg" class="swipebox" title="Shrimp Plate">
                  <img src="images/thumbnails/shrimp.jpg" alt="image" class="swipeboxImage">
                </a>
              </div>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="panel panel-default">
            <div class="panel-heading colorHeading">
              <h3 class="panel-title"><i class="fa fa-yelp"></i>&nbsp;Reviews</h3>
            </div>
            <div class="panel-body">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading colorHeading">
              <h3 class="panel-title"><i class="fa fa-heart"></i>&nbsp;About Zohra</h3>
            </div>
            <div class="panel-body">
